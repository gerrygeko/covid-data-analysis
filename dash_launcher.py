...
url_csv_national_data = "https://raw.githubusercontent.com/pcm-dpc/COVID-19/master/dati-regioni/dpc-covid19-ita-regioni.csv"

def load_csv(url):
    data_loaded = pd.read_csv(url)
    return data_loaded

df_italy_region = load_csv(url_csv_national_data)
                    ...
                    html.Div(className='four columns div-user-controls',
                             children=[
                                 ...
                                 html.Div(
                                     ...
                                     children=[
                                         dcc.Dropdown(id='regionselector', options=get_options(df_italy_region['denominazione_regione'].unique()),
                                                      multi=True, value=[df_italy_region['denominazione_regione'].sort_values()[0]],
