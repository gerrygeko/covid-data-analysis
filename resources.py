...
resources = {DEFAULT_LANGUAGE: {
    ...
    'total_administered_doses': 'Dosi totali somministrate',
    ...
    'ratio_percentage_administrations': 'Rapporto % somministrazioni',
    ...
    'immunization_rate_label': 'Ritmo di immunizzazione',
